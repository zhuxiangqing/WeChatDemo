...
public class ScanQRCodeLoginActivity extends Activity implements OAuthListener{
	...
	private static final String TAG = "SDKSample.ScanQRCodeLoginActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		authBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				String signature = "fce891bb7d181766f92172395802a21f24de93e4";//"fce891bb7d181766f92172395802a21f24de93e4";
